...
<body>
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                $username = $_GET['username'];
                                $sql = "SELECT * FROM `course_admin` WHERE `role`='speTea' AND tea_username='$username'";
    ...
    <main>
        ...
        <div class="select-year" style="display: flex;flex-flow:column wrap;margin-left:10px;">
            <label for="select-year" style="color: black;">Select Year</label>
            <select name="select-year" id="select-year" style="width: max-content;">
        ...
        <div id="change-by-yr">
            ...
            function main($year)
            {
                ...
                include "backend/include/conn.php";
                $sql1 = "select courseID,courseName from course WHERE fromAcadYr = 2021";
