...
if (isset($_POST['save'])) {
    ...
    $sql = " INSERT INTO `coursel`(fromAcadYr,toAcadYr ,sem ,subjectCode,courseName,credits,lectHr,totLectHr) VALUES ('$fromAcademicYear','$toAcademicYear','$semester','$subjectCode','$courseName','$credits','$lectureHoursPerWeek','$totalContactHours');";
    $query = mysqli_query($conn, $sql);

    $sql_courseID = "SELECT * FROM `coursel` WHERE subjectCode= '" . $subjectCode . "' ";
