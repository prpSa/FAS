...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2021 at 07:06 PM
...
CREATE TABLE `audit_docs` (
  ...
  `division` varchar(2) NOT NULL,
  `year` int(5) NOT NULL,
  `prerequisite` mediumblob,
  `documentsVerified` mediumblob,
  `defaulterList` mediumblob,
  `lms` mediumblob,
  `dcf` mediumblob,
  `eAttendance` mediumblob,
  `syllabusCoverage` mediumblob,
  `workshopConduction` mediumblob,
  `booksReferred` mediumblob,
  `identifyStudents` mediumblob,
  `evaluationLabs` mediumblob,
  `additionalExperiments` mediumblob,
  `epi` mediumblob,
  `sampleCopies` mediumblob,
  `ict` mediumblob,
  `smartBoard` mediumblob,
