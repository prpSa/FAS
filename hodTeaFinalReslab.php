...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <a href="hodhomelab.php?username=<?php echo $username; ?>"><img src="dylogo.png" style="width:10rem; height:4rem" ></a>
        </div>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="hodhomelab.php?username=<?php echo $username; ?>" class="dropdown-item" style="font-size:1rem; font-weight:600"><i class="fas fa-home fa-sm fa-fw mr-2 text-gray-400"></i>Home Page</a>
    ...
    <form action="hodhomelab.php?username=<?php echo $username; ?>" method="post">
        <main>
...
########################################################################################################### -->
    ...
    <input type="submit" name="submit" value="Back To Homepage" style="margin:2rem 44% 1rem" class="btn btn-success"><a href="hodhomelab.php"></a></input>
