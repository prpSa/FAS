<?php
    ...
    if ($total != 0) {
        while ($result = mysqli_fetch_assoc($data)) {
            echo '<a href="hodAudFeed.php?username='.$username.'&division='.$division.'&courseID='.$courseID.'&audType='.$audType.'" ><button id="hodAud1Green">HOD Audit 1</button></a>';
        }
    } else {
    ...
    if ($total != 0) {
        while ($result = mysqli_fetch_assoc($data)) {
            echo '<a href="hodAudFeed.php?username='.$username.'&division='.$division.'&courseID='.$courseID.'&audType='.$audType.'"  ><button id="hodAud2Green">HOD Audit 2</button></a>';
        }
    } else {
    ...
    if ( $total != 0) { 
        while($result=mysqli_fetch_assoc($data)) {
            ...
            if(strcmp($result['teacherInt'],"submitted")===0 && strcmp($result['audType'],"aud1")===0){
                echo '<a href="auditorTeamSub.php?username='.$username.'&division='.$division.'&courseID='.$courseID.'&tea_username='.$tea_username.'" ><button id="teaOrange">Documents for Audit I</button></a>';
                echo '<a href="auditorViewResponseSub.php?username='.$username.'&division='.$division.'&courseID='.$courseID.' " ><button id="teaGreen">View Response I</button></a>';
            }
                ...
                echo '<a href="auditorViewResponseSub.php?username='.$username.'&division='.$division.'&courseID='.$courseID.' " ><button id="teaGreen">Documents for Audit I</button></a>';
            }
        ...
        if(strcmp($result['teacherInt'], "approved") === 0 &&  strcmp($result['audType'],"aud1")===0){
            if(strcmp($result['teacherIntII'],"submitted")===0 && strcmp($result['audType'],"aud1")===0){
                echo '<a href="auditorTeamSub2.php?username='.$username.'&division='.$division.'&courseID='.$courseID.'&tea_username='.$tea_username.'" ><button id="teaIIOrange">Documents for Audit II</button></a>';
            }
                ...
                echo '<a href="auditorIIViewResponseSub.php?username='.$username.'&division='.$division.'&courseID='.$courseID.' " ><button id="teaGreen">View Response</button></a>';
            }
            else if(strcmp($result['teacherIntII'], "approved") === 0 && strcmp($result['audType'],"aud1")===0){
                echo '<a href="auditorIIViewResponseSub.php?username='.$username.'&division='.$division.'&courseID='.$courseID.' " ><button id="teaIIGreen">Documents for Audit II</button></a>';
            }
