...
<body>
    ...
    <?php
            ...
            header('Location: subjectTeacherHome.php?username=' . $username . '');
            exit;
        }
    }
    ?>
...
<div class="bs-example">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse">
        ...
        <a href="auditorHome.php?username=<?php echo $username; ?>"><img src="dylogo.png" style="width:10rem; height:4rem" ></a>
        </div>
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown" >
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="auditorHome.php?username=<?php echo $username; ?>" class="dropdown-item" style="font-size:1rem; font-weight:600">Main Audit</a>
